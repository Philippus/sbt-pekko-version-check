...
object PekkoVersionCheckPlugin extends AutoPlugin {
  ...
  private val coreModules = Set(
    "pekko" ,"pekko-actor" ,"pekko-actor-testkit-typed" ,"pekko-actor-tests", "pekko-actor-typed" ,"pekko-actor-typed-tests",
    "pekko-cluster", "pekko-cluster-metrics", "pekko-cluster-sharding", "pekko-cluster-sharding-typed", "pekko-cluster-tools",
    "pekko-cluster-typed", "pekko-coordination", "pekko-discovery", "pekko-distributed-data", "pekko-multi-node-testkit" ,
    "pekko-osgi", "pekko-persistence", "pekko-persistence-query", "pekko-persistence-shared", "pekko-persistence-tck" ,
    "pekko-persistence-typed", "pekko-protobuf", "pekko-protobuf-v3", "pekko-remote", "pekko-serialization-jackson",
    "pekko-slf4j", "pekko-stream", "pekko-stream-testkit","pekko-stream-typed", "pekko-testkit"
  )
  private val pekkoHttpModules = Set(
    "pekko-http", "pekko-http-caching", "pekko-http-core", "pekko-http-jackson", "pekko-http-marshallers-java",
    "pekko-http-marshallers-scala", "pekko-http-root", "pekko-http-spray-json", "pekko-http-testkit", "pekko-http-xml",
    "pekko-http2-support", "pekko-parsing")
